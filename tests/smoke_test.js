...
assert(html.includes('app.js?v=157'), 'index.html 版本 v157');
assert(html.includes('style.css?v=157'), 'index.html 样式版本 v157');

// 6. Service Worker
console.log('\n【6】Service Worker');
const sw = fs.readFileSync(path.join(__dirname, '..', 'service-worker.js'), 'utf8');
assert(sw.includes('family-finance-v157'), 'SW 版本 v157');
