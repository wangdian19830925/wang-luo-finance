...
assert(html.includes('app.js?v=178'), 'index.html 版本 v178');
assert(html.includes('style.css?v=178'), 'index.html 样式版本 v178');

// 6. Service Worker
console.log('\n【6】Service Worker');
const sw = fs.readFileSync(path.join(__dirname, '..', 'service-worker.js'), 'utf8');
assert(sw.includes('family-finance-v178'), 'SW 版本 v178');
