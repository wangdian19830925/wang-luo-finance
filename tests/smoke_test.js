...
assert(html.includes('app.js?v=206'), 'index.html 版本 v206');
assert(html.includes('style.css?v=206'), 'index.html 样式版本 v206');

// 6. Service Worker
console.log('\n【6】Service Worker');
const sw = fs.readFileSync(path.join(__dirname, '..', 'service-worker.js'), 'utf8');
assert(sw.includes('family-finance-v206'), 'SW 版本 v206');
