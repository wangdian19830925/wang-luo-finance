...
def main():
    ...
    files_to_deploy = [
        ...
        ("docs/测试报告-v205.md", "docs/测试报告-v205.md", False),
        ...
        # v210: CloudBase 云函数
        ("cloudbase/ARCHITECTURE.md", "cloudbase/ARCHITECTURE.md", False),
        ("cloudbase/cloudbaserc.json", "cloudbase/cloudbaserc.json", False),
        ("cloudbase/functions/shared/constants.js", "cloudbase/functions/shared/constants.js", False),
        ("cloudbase/functions/shared/utils.js", "cloudbase/functions/shared/utils.js", False),
        ("cloudbase/functions/fetch-market-data/index.js", "cloudbase/functions/fetch-market-data/index.js", False),
        ("cloudbase/functions/fetch-market-data/package.json", "cloudbase/functions/fetch-market-data/package.json", False),
        ("cloudbase/functions/fetch-market-data/config.json", "cloudbase/functions/fetch-market-data/config.json", False),
        ("cloudbase/functions/fetch-market-data/lib/stock.js", "cloudbase/functions/fetch-market-data/lib/stock.js", False),
        ("cloudbase/functions/fetch-market-data/lib/fx.js", "cloudbase/functions/fetch-market-data/lib/fx.js", False),
        ("cloudbase/functions/fetch-market-data/lib/fund.js", "cloudbase/functions/fetch-market-data/lib/fund.js", False),
        ("cloudbase/functions/fetch-market-data/lib/db.js", "cloudbase/functions/fetch-market-data/lib/db.js", False),
        ("cloudbase/functions/fetch-macro-data/index.js", "cloudbase/functions/fetch-macro-data/index.js", False),
        ("cloudbase/functions/fetch-macro-data/package.json", "cloudbase/functions/fetch-macro-data/package.json", False),
        ("cloudbase/functions/fetch-macro-data/config.json", "cloudbase/functions/fetch-macro-data/config.json", False),
        ("cloudbase/functions/fetch-macro-data/lib/news.js", "cloudbase/functions/fetch-macro-data/lib/news.js", False),
        ("cloudbase/functions/fetch-macro-data/lib/fx-history.js", "cloudbase/functions/fetch-macro-data/lib/fx-history.js", False),
        ("cloudbase/functions/fetch-macro-data/lib/db.js", "cloudbase/functions/fetch-macro-data/lib/db.js", False),
        ("cloudbase/functions/generate-briefing/index.js", "cloudbase/functions/generate-briefing/index.js", False),
        ("cloudbase/functions/generate-briefing/package.json", "cloudbase/functions/generate-briefing/package.json", False),
        ("cloudbase/functions/generate-briefing/config.json", "cloudbase/functions/generate-briefing/config.json", False),
        ("cloudbase/functions/generate-briefing/lib/calculator.js", "cloudbase/functions/generate-briefing/lib/calculator.js", False),
        ("cloudbase/functions/generate-briefing/lib/formatter.js", "cloudbase/functions/generate-briefing/lib/formatter.js", False),
        ("cloudbase/functions/generate-briefing/lib/db.js", "cloudbase/functions/generate-briefing/lib/db.js", False),
        ("cloudbase/functions/get-cloud-data/index.js", "cloudbase/functions/get-cloud-data/index.js", False),
        ("cloudbase/functions/get-cloud-data/package.json", "cloudbase/functions/get-cloud-data/package.json", False),
        ("cloudbase/functions/get-cloud-data/lib/db.js", "cloudbase/functions/get-cloud-data/lib/db.js", False),
    ]
